...
export const metadata: Metadata = {
  title: 'CartelFakes — Premium Fake IDs',
  description: 'CartelFakes — the #1 source for premium scannable fake IDs. Serving USA, Canada, UK, Europe and more. Quality guaranteed.',
  icons: {
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              _smartsupp.key = '332a87c13eab9b0f85e426fa0529e4726740caba';
