...
const allReviews = [
  ...
  { name: 'Brittany J.', location: 'Georgia, USA', rating: 5, text: 'Second order with CartelFakes and quality keeps getting better. Free duplicate is a huge bonus — always nice to have a backup.' },
