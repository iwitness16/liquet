...
const ADMIN_WHATSAPP = '16616465626'
...
function OrdersInner() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setPayMethod('')
      setQty(1)
      setPhotoPreview('/images/headshot.jpg')
      setSigPreview('/images/signature.jpg')
      setPhotoBase64('')
      setSigBase64('')
                ...
                {submitting ? (
                  <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
                    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2"
                      strokeLinecap="round" className="spin"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>
                    Sending…
                  </span>
                ) : (
                  <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
