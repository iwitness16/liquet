...
const faqs = [
  ...
  },
  {
    ...
    answer: 'We love customer reviews! If you send us a video review of your CartelFakes id we will give you a discount on your next order. Contact us with your video for details.',
  },
  {
    Icon: Clock,
  ...
  },
  {
    ...
    answer: 'CartelFakes does not scam customers. If you believe there is an issue with your order, contact us directly and we will resolve it. Beware of imposter sites using our name — always verify you are on the correct website.',
  },
  {
    Icon: PenLine,
  ...
  },
  {
    Icon: FlipHorizontal,
    question: 'Bend test?',
    answer: 'All CartelFakes ids are printed on genuine polycarbonate card material — the same material used in real government-issued ids. They will pass the bend test and make the characteristic sound when flexed.',
  },
  {
    Icon: ScanLine,
      ...
      <main>
        ...
        <div className="faq-page shell">
          <p className="faq-intro">
            Answers to the most frequently asked questions when ordering from CartelFakes.
          </p>
