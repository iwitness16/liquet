          ...
          <div className="contact-grid">
            ...
            <div className="contact-info">
              ...
              <div className="contact-social">
                <a href="https://wa.me/16616465626" className="social-btn social-wa" aria-label="Chat on WhatsApp" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://t.me/idkingk90" className="social-btn social-tg" aria-label="Message on Telegram" target="_blank" rel="noopener noreferrer">
                ...
                <a href="mailto:cartelfakes@gmail.com" className="social-btn social-em" aria-label="Send an email">
