...
export default function AboutPage() {
  return (
    <>
      <SiteHeader active="About CartelFakes" />
      <main>
        <PageHeader title="ABOUT CARTELFAKES" />

        <div className="about-page shell">

          <h2>Who Is CartelFakes?</h2>
          <p>
            CartelFakes is one of the most trusted names in the premium fake ID industry. We have been
          ...
          <p>
            Unlike fly-by-night operations that appear and disappear overnight, CartelFakes has
          ...
          <p>
            ...
            customers. Always verify you are on the correct CartelFakes website. We will never ask you
            to pay through unofficial or sketchy payment channels without prior communication.
          </p>
          <p>
            If in doubt, reach out to us directly via our official Telegram (@cartelfakes) or WhatsApp
