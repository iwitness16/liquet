...
const navLinks = [
  ...
  { label: 'About CartelFakes', href: '/about' },
  ...
  return (
    <header className="site-header">
      ...
      <div className="shell header-top">
        <Link href="/" className="brand-logo" aria-label="CartelFakes home">
          <Image
            ...
            height={72}
            priority
            style={{ height: 'clamp(52px, 7vw, 72px)', width: 'auto', objectFit: 'contain' }}
          />
        </Link>
  ...
  return (
    <footer className="site-footer">
      <div className="footer-main">
        <div className="shell footer-grid">
          ...
          <div className="footer-col">
            {/* Logo at the very top of the first column */}
            <div className="footer-logo-wrap">
              <Link href="/" aria-label="CartelFakes home">
                <Image
                  src="/images/cartellogo.jpg"
                  alt="CartelFakes"
                  width={140}
                  height={44}
                  style={{ height: 'clamp(32px, 4vw, 44px)', width: 'auto', objectFit: 'contain', filter: 'brightness(1.1)' }}
                />
              </Link>
            </div>
          ...
          <div className="footer-col footer-about">
            <h4>About</h4>
            <p><strong>Company:</strong> CartelFakes Inc.</p>
            <p><strong>WhatsApp:</strong> +1 (661) 646-5626</p>
            <p><strong>Telegram:</strong> @idkingk90</p>
            <p><strong>Email:</strong> cartelfakes@gmail.com</p>
            <div className="footer-social">
              <a href="https://wa.me/16616465626" className="social-btn social-wa" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://t.me/idkingk90" className="social-btn social-tg" aria-label="Telegram" target="_blank" rel="noopener noreferrer">
              ...
              <a href="mailto:cartelfakes@gmail.com" className="social-btn social-em" aria-label="Email">
      ...
      <div className="shell footer-bottom">
        <span>Copyright © 2026, CartelFakes, All Rights Reserved</span>
      </div>
